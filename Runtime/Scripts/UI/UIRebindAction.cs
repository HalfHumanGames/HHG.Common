...
namespace HHG.Common.Runtime
{
    ...
    public class UIRebindAction : MonoBehaviour
    {
        ...
        /// <summary>
        /// Optional TMP_Text component that receives a TMP_Text prompt when waiting for a control to be actuated.
        /// </summary>
        ...
        {
            if (s_UIRebindActions == null)
                s_UIRebindActions = new List<UIRebindAction>();
            s_UIRebindActions.Add(this);
            if (s_UIRebindActions.Count == 1)
        ...
        protected void OnDisable()
        {
            ...
            s_UIRebindActions.Remove(this);
            if (s_UIRebindActions.Count == 0)
            {
                s_UIRebindActions = null;
                InputSystem.onActionChange -= OnActionChange;
            }
        }
        ...
        private static void OnActionChange(object obj, InputActionChange change)
        {
            ...
            for (var i = 0; i < s_UIRebindActions.Count; ++i)
            {
                var component = s_UIRebindActions[i];
        ...
        private static List<UIRebindAction> s_UIRebindActions;
